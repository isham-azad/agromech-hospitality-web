              ...
              <div className="relative aspect-[3/4] bg-zinc-950 rounded-2xl sm:rounded-[2.5rem] overflow-hidden border border-zinc-100 shadow-sm transition-all duration-700 group-hover:shadow-[0_30px_60px_rgba(0,0,0,0.12)]">
                ...
                <div className="absolute inset-0 p-4 sm:p-8 flex flex-col justify-between z-10">
                  <div className="flex justify-between items-start">
                    ...
                    <span className="px-2 sm:px-3 py-0.5 sm:py-1 rounded-full bg-[#D4AF37] text-[6px] sm:text-[8px] font-black uppercase tracking-widest text-white">
                      {cat.year}
                    </span>
                  </div>
                  <div className="space-y-1 sm:space-y-2">
                    <span className="text-[#D4AF37] text-[7px] sm:text-[9px] font-black uppercase tracking-[0.3em] block">
                      {cat.category}
                    </span>
                    ...
                    <div className="flex items-center gap-1.5 text-white/70 text-[8px] sm:text-[10px] font-black uppercase tracking-widest pt-2">
                      ...
                      <span className="group-hover:text-[#D4AF37] transition-colors">Request Catalogue</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              ...
              <div>
                <div className="flex justify-between items-center mb-8 border-b border-white/10 pb-6">
                  <div>
                    <span className="text-[#D4AF37] text-[9px] font-black uppercase tracking-[0.3em] block mb-1">
                      Request Catalogue
                    </span>
                  ...
                  {!isSuccess ? (
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-[8px] font-black uppercase tracking-widest text-[#D4AF37] mb-2">
                          ...
                          <input
                            ...
                            placeholder="John"
                            className={`w-full bg-white/5 border ${formErrors.firstname ? "border-red-500" : "border-white/10"} rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all`}
                          />
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={handleInputChange}
                            placeholder="Doe"
                            className={`w-full bg-white/5 border ${formErrors.lastname ? "border-red-500" : "border-white/10"} rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all`}
                          />
                          {formErrors.lastname && (
                      ...
                      <div>
                        <label className="block text-[8px] font-black uppercase tracking-widest text-[#D4AF37] mb-2">
                          Company Email <span className="text-[#D4AF37]">*</span>
                        </label>
                        <input
                          type="email"
                          name="email"
                          ...
                          className={`w-full bg-white/5 border ${formErrors.email ? "border-red-500" : "border-white/10"} rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all`}
                        />
                        {formErrors.email && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full bg-white/5 border ${formErrors.mobile ? "border-red-500" : "border-white/10"} rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all`}
                        />
                        {formErrors.mobile && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full bg-white/5 border ${formErrors.companyName ? "border-red-500" : "border-white/10"} rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all`}
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full bg-white/5 border ${formErrors.country ? "border-red-500" : "border-white/10"} rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all`}
                        />
                        {formErrors.country && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-[#D4AF37] transition-all"
                        />
                      </div>
                      ...
                      <button
                        ...
                        className="w-full bg-[#D4AF37] hover:bg-[#b8962d] text-white py-4 rounded-xl font-bold uppercase tracking-widest text-xs transition-all active:scale-[0.98] focus:outline-none flex justify-center items-center gap-2 mt-8 shadow-xl"
                      >
                        {isSubmitting ? (
                          <>
                    ...
                    >
                      <div className="w-20 h-20 bg-[#D4AF37]/10 rounded-full flex items-center justify-center border-2 border-[#D4AF37] mb-4">
                        <i className="fas fa-check text-4xl text-[#D4AF37]"></i>
                      </div>
                      <h4 className="text-2xl font-black uppercase tracking-tight text-white">Verification Complete</h4>
                      <p className="text-white/60 text-sm max-w-sm leading-relaxed font-light">
                        Thank you, {formData.firstname}. Your corporate details have been registered successfully. You can download the PDF archive immediately below.
                      </p>
                      ...
                      <div className="pt-6 w-full">
                        <a
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            alert(`Downloading ${selectedCatalogue.title} PDF Brochure...`);
                          }}
                          className="w-full bg-[#D4AF37] hover:bg-[#b8962d] text-white py-4 rounded-xl font-bold uppercase tracking-widest text-xs transition-all active:scale-[0.98] focus:outline-none flex justify-center items-center gap-2 no-underline shadow-xl"
                        >
                          <i className="fas fa-download"></i>
                          <span>Download PDF ({selectedCatalogue.pages} Pages)</span>
                        </a>
                      </div>
                    </motion.div>
                  )}
              ...
              <div className="border-t border-white/10 pt-6 mt-12 text-center text-white/50 text-[10px] space-y-1">
                ...
                <p className="font-bold text-[#D4AF37]">info@agromech.com &mdash; +971 4 123 4567</p>
              </div>
            </motion.div>
          </>
        )}
