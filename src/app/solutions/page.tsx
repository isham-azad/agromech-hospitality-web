    ...
    <main className="bg-zinc-50 min-h-screen">
      ...
      <section className="relative h-[60vh] mt-5 flex items-center justify-center overflow-hidden bg-[#221F51]">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          ...
          >
            <span className="text-[#D4AF37] font-bold uppercase tracking-[0.4em] mb-4 block text-xs md:text-sm">Turnkey Excellence</span>
            <h1 className="text-3xl md:text-6xl font-black text-white uppercase tracking-tight mb-6 leading-tight">
              ...
              <span className="text-[#D4AF37]">World-Class Hospitality</span>
            </h1>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {oseSolutions.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37] group-hover:bg-[#221F51] group-hover:text-white transition-all duration-300">
      ...
      <section className="py-20 md:py-28 px-6 bg-[#221F51] relative overflow-hidden text-white">
        <div className="absolute left-0 bottom-0 w-64 h-64 bg-[#D4AF37]/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {kitchenSolutions.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-2xl bg-[#D4AF37]/20 flex items-center justify-center text-[#D4AF37] group-hover:bg-[#221F51] group-hover:text-white transition-all duration-300 shrink-0">
                  <i className={`fas ${item.icon} text-lg`}></i>
                </div>
                <div className="space-y-2">
                  <h4 className="font-bold uppercase tracking-wider text-sm text-[#D4AF37] group-hover:text-[#221F51]">
                    {item.title}
                  </h4>
      ...
      <section className="py-20 md:py-28 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <span className="text-[#D4AF37] font-bold text-xs tracking-[0.3em] uppercase block mb-3">Our Core Advantage</span>
            <h2 className="text-3xl md:text-5xl font-black text-zinc-900 uppercase tracking-tight mb-4">
              Why Clients Choose <span className="text-[#D4AF37]">Agromech Solutions</span>
            </h2>
      ...
      <section className="py-16 md:py-24 bg-white border-t border-zinc-100">
        <div className="container mx-auto px-6 max-w-6xl flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <Link
            href="/contact"
            className="inline-block bg-[#221F51] text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest hover:!bg-[#D4AF37] hover:!text-[#221F51] transition-all no-underline shadow-xl whitespace-nowrap text-xs md:text-sm active:scale-95"
          >
            Start Your Project
          </Link>
        </div>
